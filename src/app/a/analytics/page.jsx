...
export default function StudentAnalyticsDashboard() {
  ...
  // ✅ Always-visible section (not collapsible)
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <StatCard title="Total Students" value={analytics.totalStudents} icon={Users} color="blue" />
            <StatCard title="Average Pre-test" value={analytics.avgPretest} icon={BookOpen} subtitle="out of 100" color="orange" />
            <StatCard title="Average Post-test" value={analytics.avgPosttest} icon={Target} subtitle="out of 100" color="green" />
            <StatCard title="Average Improvement" value={`${analytics.avgImprovement}%`} icon={TrendingUp} color="purple" />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            <Section title="Class-wise Performance Comparison">
            ...
            <Section title="Post-test Score Distribution">
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
          ...
          <Section title="Individual Improvement Analysis">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Section title="Top 5 Improved Students">
            ...
            <Section title="Students Needing Extra Support">
              <div className="space-y-3">
